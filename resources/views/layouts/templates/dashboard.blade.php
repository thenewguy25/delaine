...
<body class="dashboard-container">
    <div class="flex h-screen">
        <!-- Sidebar -->
        <div id="sidebar" class="dashboard-sidebar w-64 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out lg:static lg:inset-0">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="relative">
                            <button class="flex items-center text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <img class="w-8 h-8 rounded-full" src="https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->name ?? 'User') }}&background=blue&color=white" alt="User">
